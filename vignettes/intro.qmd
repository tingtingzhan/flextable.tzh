...
c(
  ...
  '[`aov`](https://search.r-project.org/R/refmans/stats/html/aov.html), [`anova`](https://search.r-project.org/R/refmans/stats/html/anova.html)', 'Analysis of variance (tables)',
